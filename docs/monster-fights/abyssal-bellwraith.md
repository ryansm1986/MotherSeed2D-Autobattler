...
Abyssal Bellwraith is the sixth-room solo boss encounter. It is a cracked cathedral-bell spirit that fights like a deliberate ARPG boss: narrow line checks, wide fan shards with readable gaps, delayed grave circles, and an expanding hollow nova. Phase 2 begins below 50% health and adds denser fans plus a second delayed nova ring.
...
| `tolling_fan` | Wide projectile fan | 1.02s windup, 0.12s active, 0.62s recovery | 12 per shard | Dodge through a gap; phase 2 fires 11 shards. |
